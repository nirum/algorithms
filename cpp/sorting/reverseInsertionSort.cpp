/* reverseInsertionSort.cpp
 * implementation of insertion sort, but sorting in non-increasing order
...
int main() {
	...
	for (int li = 0; li < N; li++) {
		...
		std::cout << "sorting list of size " << pow(2,li) << " ... ";
